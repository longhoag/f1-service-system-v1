...
Replaces LangGraph orchestrator with intelligent agent that binds tools for:
- Circuit image retrieval
- F1 regulations queries via Bedrock

No hardcoded routing or aliases - GPT-5 Mini understands queries naturally.
"""
...
class GPT5Agent:
    """
    GPT-5 Mini agent with tool calling for F1 information queries.
    ...
    def __init__(self):
        """Initialize GPT-5 Mini agent with tools."""
        logger.info("Initializing GPT-5 Mini Agent with tool calling")
        ...
        logger.success("GPT-5 Mini Agent initialized")
